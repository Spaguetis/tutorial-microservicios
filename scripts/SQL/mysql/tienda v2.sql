...
ADD rol ENUM('admin', 'cliente') NOT NULL DEFAULT 'cliente';

select * from usuarios_admin limit 10;

ALTER TABLE usuarios_admin ADD rol VARCHAR(20);
ALTER TABLE usuarios_admin MODIFY COLUMN rol VARCHAR(20) DEFAULT 'admin';